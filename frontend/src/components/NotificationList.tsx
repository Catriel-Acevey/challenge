...
import type { ChannelType, NotificationStatus, Notification } from '../types/api';
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <button
                      ...
                      className="text-blue-400 hover:text-blue-600 p-2 rounded-lg hover:bg-blue-50 transition cursor-pointer"
                      title="Editar"
                    >
                    ...
                    <button
                      ...
                      className="text-red-400 hover:text-red-600 p-2 rounded-lg hover:bg-red-50 transition disabled:opacity-50 cursor-pointer"
                      title="Eliminar"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
